...
$ct=$_POST['coursetype'];
$yt=$_POST['yeartype'];
mysql_query("insert into exam_test(test_id,sub_id,test_name,total_que,total_time,dateofexam,start_time,dept,ctype,year) values ('$testid','$subid','$testname','$totque','$tottime','0000-00-00','00:00:00','$deptname','$ct','$yt')") or die(mysql_error());
...
<form name="form1" id="form1" method="post" onSubmit="return check();">
  <table width="58%"  border="0" align="center">
    <tr>
      <td width="49%" height="32"><div align="left"><strong>Select Subject/Category</strong></div></td>
      <td width="3%" height="5">  
...
?>
    ...
    <tr>
      <td height="26"><div align="left"><strong>Enter Total no. of Question </strong></div></td>
      <td>&nbsp;</td>
      <td><input name="totque" type="text" id="totque"></td>
    </tr>
     <tr>
      <td height="26"><div align="left"><strong>Enter Max. time (in mins) </strong></div></td>
      <td>&nbsp;</td>
