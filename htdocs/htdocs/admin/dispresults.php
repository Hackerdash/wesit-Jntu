...
$testid=$_POST['examselect'];
$detsql="select test_name,dateofexam,dept,total_time,total_que from exam_test where test_id='$testid'";
...
<table align="center" width="90%" border=1>
	...
	<tr><td colspan=1>Exam Name</td><td colspan=3><b><?php echo $detdata[0];?></b></td><td colspan=2>Date of Exam</td><td colspan=2><b><?php echo $detdata[1]; ?></b></td>
	<tr><td colspan=1>Regulation</td><td colspan=1><b>-</b></td><td colspan=1>Department</td><td colspan=1><b><?php echo $detdata[2]; ?></b></td><td colspan=1>Tot.Time</td><td colspan=1><b><?php echo $detdata[3]." mins"; ?></b></td><td colspan=1>Tot.Marks</td><td colspan=1><b><?php echo $detdata[4]; ?></b></td>
