...
<html lang="en">
	...
	<body>   
<center><h2>Upload Excel Sheet (in .xls Format[excel 97-2003 format])</h2></center> 
<div id="options">
<center>
<ul>
...
<div class="control-group">
							...
							<div class="controls">
                                ...
                                <?php
                                $sqlstmt2 = "SELECT DISTINCT `sub_id` FROM `exam_test` WHERE `dept`='$deptname'";
				...
				<form class="form-horizontal well" action="uploadquedata.php" method="post" name="upload_excel" enctype="multipart/form-data">
					<fieldset>
						<legend>Import Exam Questions file</legend>
