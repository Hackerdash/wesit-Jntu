...
if(isset($_POST['submit']))
{
    ...
    $rs=mysql_query("select * from exam_superadmin where username='$loginid' and password='$pass'");
...
<html>
<head>
<title>Superadmin epic exam</title>
<style>
...
<center>
<h2 style="position: absolute; top:35%; left:30%; font-size:30px; color:teal;">Welcome to High level administrative login</h2>
